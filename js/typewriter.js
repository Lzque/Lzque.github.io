                ...
                if (xiaBiao != txt.length - 1) {
                    if (xiaBiao != 0) {
                        ...
                        if (text.innerHTML.length === txt[xiaBiao].length) {
                            ...
                            $(".introduce").eq(xiaBiao).html(text.innerHTML);
                        ...
                        if (index === 7) {
                            $(text).animate({"opacity": 0}, text.innerHTML.length * 799, "linear", function () {
                            });
                            $(".introduce").eq(xiaBiao).html(text.innerHTML);
                            $(".introduce").eq(xiaBiao).animate({"opacity": 1}, text.innerHTML.length * 300, "linear", function () {
                            });
                        }
                    }
                    if (index === 0) {
